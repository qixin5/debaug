...
void FileManager::copySampleAsInputFile(std::string SampleId) {
  llvm::sys::fs::copy_file(getSampleFileName(SampleId, "c"), OptionManager::InputFile);
}

void FileManager::copyAsOriginalInputFile() {
  std::string Origin = OptionManager::InputFile + ".origin.c";
  llvm::sys::fs::copy_file(Origin, OptionManager::InputFile);
}
