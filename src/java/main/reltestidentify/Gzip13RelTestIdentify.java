...
public class Gzip13RelTestIdentify
{
	...
	for (String target_fline : target_flines) {
		...
		for (String elem : core_part.split("\\s+")) {
			...
			if (elem.startsWith("--uncompress") || elem.startsWith("--decompress")) {
			    option_flags.add("-d");
			}
			else if (elem.startsWith("--fast")) {
			    option_flags.add("-1");
			}
			else if (elem.startsWith("--test")) {
			    option_flags.add("-t");
			}
			else if (elem.startsWith("--quiet")) {
			    option_flags.add("-q");
			}
			else if (elem.startsWith("--best")) {
			    option_flags.add("-9");
			}
			else if (elem.startsWith("--stdout")) {
			    option_flags.add("-c");
			}
			else if (elem.startsWith("--force")) {
			    option_flags.add("-f");
			}
			else if (elem.startsWith("--verbose")) {
			    option_flags.add("-v");
			}
			else if (elem.startsWith("--recursive")) {
			    option_flags.add("-r");
			}
			...
			else if (elem.startsWith("--license")) {
			    option_flags.add("-L");
			}			
		    }
