...
public class Printtokens2TestGen
{
    public static void main(String[] args) {
	String origin_test_fpath = "/home/qxin6/debaug_expt/debaug/benchmark/printtokens2_template/testscript/universe";
	...
	if (cmd0.startsWith("< ")) {
	    sb.append(" < $INDIR/" + cmd0.substring(2)); //Need to add directory path
	}
	else {
	    sb.append(" " + cmd0.replace(old_input_path+"/", "$INDIR/"));
	}
