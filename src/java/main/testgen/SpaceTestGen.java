...
public class SpaceTestGen
{
    public static void main(String[] args) {
	String origin_test_fpath = "/home/qxin6/debaug_expt/debaug/benchmark/space_template/testscript/universe";
	...
	String new_cmd0 = cmd0.replace(old_input_str0+"/", "$INDIR/");
